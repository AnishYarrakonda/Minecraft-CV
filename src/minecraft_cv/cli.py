...
def main_gestures(argv: list[str] | None = None) -> int:
    ...
    print("\n[Screen Joysticks]")
    print("  Left hand   -> WASD movement via Pinches")
    print("  Right thumb -> Direct mouse/cursor movement")
    print("\n[Left Hand - Actions]")
    print("  Index Pinch  -> Move Right (D)")
    print("  Middle Pinch -> Move Forward (W)")
    print("  Ring Pinch   -> Move Left (A)")
    print("  Pinky Pinch  -> Move Back (S)")
    print("\n[Right Hand - Holds]")
    print("  Index Pinch  -> Attack/Mine (Left Click)")
    print("  Middle Pinch -> Use/Place (Right Click)")
    print("  Ring Pinch   -> Jump (Space)")
    print("  Peace Sign   -> Recenter mouse and pause input")
    print("\n[Face Gestures]")
    print("  Raise Eyebrows  -> Inventory (E)")
    print("  Open Mouth      -> Throw Item (Q)")
    print("  Puff Cheeks     -> Sneak (Shift)")
    print("  Shift Jaw Right -> Swap Offhand (F)")
    print("\n[Head Gestures]")
    print("  Tilt Left  -> Hotbar Scroll Up")
    print("  Tilt Right -> Hotbar Scroll Down")
    return 0
